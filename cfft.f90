...
!     
!     computes complex 3d fft of chd
!     $Id: cfft.f,v 1.1.1.1 1992/05/08 19:44:47 jimb Exp $
!
!     $Log: cfft.f,v $
! Revision 1.1.1.1  1992/05/08  19:44:47  jimb
!
!     Revision 1.1  89/03/11  19:09:31  sverre
!     Initial revision
!     
!     
...
!     level 2, chdr,chdi
!     
! I   n1,n2,n3            grid size
! IO  chd(r,i)(i,j,k)     i=1,n1,j=1,n2,k=1,n3.
!     .                   array to be fourier transformed
!     wrk(i)              i=1,6*max(n1,n2,n3)+15
!     .                   work array
!     lwrk                length of wrk
! I   mode                determines transform mode
!     .                   mode > 0   forward
!     .                   mode < 0   backward
!
!     rcs id string - allows use of ident to identify binaries
!
      character rcsid*50
