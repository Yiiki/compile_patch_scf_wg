...
!!!!  emotif box volume
     ...
     &    mot_z*dens_mEM(ixyz,jxyz,kxyz,jchi,itype)*vol_fac
      ...
      ! sum atom
      dipall(1,jchi)=dipall(1,jchi)+dipmot(1,jchi,iatom)
      dipall(2,jchi)=dipall(2,jchi)+dipmot(2,jchi,iatom)
      dipall(3,jchi)=dipall(3,jchi)+dipmot(3,jchi,iatom)
