...
! filling in the dipmot(3,3,natom_patch)
      ...
      !write(6,*) line_in
              ...
              if(iatom.gt.natom_patch) exit
               read(11,*) 
               read(11,*) dipmot(1:3,1,iatom)
               read(11,*) dipmot(1:3,2,iatom)
               read(11,*) dipmot(1:3,3,iatom)
      end if
      end do
      close(11) 
...
!!!!!!!!!!!!!!!!!!!!!!!!      enddo
      ...
      mat_tmp=matmul(op,dipmot(1:3,1:3,iatom))
...
!                                                                 !
      write(6,"(A23,I4,A21,I4)") "--tensor-from--atom--",iatom,"---for---motif---",ind_motif0(iatom)
